  ...
  tiers: [
    {
      ...
      name: 'Sitio web',
      price: 'A cotizar',
      pitch: 'La página que vende por ti: sencilla de editar y lista para recibir pedidos.',
      accent: '#4f95ff',
      features: [
        'Sitio a medida, no plantilla',
        'Pedidos en línea desde tu página',
        'Panel para editar contenido tú mismo',
        'Identidad visual aplicada',
        'SEO técnico, dominio y publicación',
      ],
    },
    {
      id: 'operacion',
      name: 'Operación',
      price: 'A cotizar',
      pitch: 'La administración completa por dentro: punto de venta, CRM y tu equipo en un solo sistema.',
      accent: '#4f95ff',
      featured: true,
      features: [
    ...
    },
    {
      ...
      name: 'Flujo completo',
      price: 'A cotizar',
      pitch: 'Todo conectado: la página, el punto de venta, el CRM y las automatizaciones hablando entre sí.',
      accent: '#4f95ff',
      features: [
        'Web conectada al punto de venta',
        'CRM y automatizaciones integradas',
        'Pedidos en línea directo a tu caja',
        'Tableros de dueño en tiempo real',
        'Soporte prioritario',
      ],
    },
  ],
...
export const CONTACT_SECTION = {
  ...
  title: ['¿Listo para crear algo?', 'Hablemos.'],
